...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetricProbeExecutable.metric'
        db.alter_column(u'poem_metricprobeexecutable', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poem.Metric'], null=True))
        ...
        # Changing field 'MetricConfig.metric'
        db.alter_column(u'poem_metricconfig', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poem.Metric'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MetricProbeExecutable.metric'
        db.alter_column(u'poem_metricprobeexecutable', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(default=' ', to=orm['poem.Metric']))

        # Changing field 'MetricProbeExecutable.value'
        db.alter_column(u'poem_metricprobeexecutable', 'value', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'MetricConfig.key'
        db.alter_column(u'poem_metricconfig', 'key', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'MetricConfig.metric'
        db.alter_column(u'poem_metricconfig', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(default=' ', to=orm['poem.Metric']))

        # Changing field 'MetricConfig.value'
        db.alter_column(u'poem_metricconfig', 'value', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))
    ...
    models = {
        ...
        'poem.metricprobeexecutable': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metric': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['poem.Metric']", 'null': 'True', 'blank': 'True'}),
            'value': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'})
        },
        'poem.metrics': {
