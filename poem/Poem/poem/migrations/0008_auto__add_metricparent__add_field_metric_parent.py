...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetricParent'
        db.create_table(u'poem_metricparent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('metric', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poem.Metric'], null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=384, null=True)),
        ))
        db.send_create_signal('poem', ['MetricParent'])

        # Adding field 'Metric.parent'
        db.add_column(u'poem_metric', 'parent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MetricParent'
        db.delete_table(u'poem_metricparent')

        # Deleting field 'Metric.parent'
        db.delete_column(u'poem_metric', 'parent')
