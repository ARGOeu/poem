...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.egiid'
        db.add_column(u'poem_userprofile', 'egiid',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.displayname'
        db.add_column(u'poem_userprofile', 'displayname',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.egiid'
        db.delete_column(u'poem_userprofile', 'egiid')

        # Deleting field 'UserProfile.displayname'
        db.delete_column(u'poem_userprofile', 'displayname')
    ...
    models = {
        ...
        'poem.userprofile': {
            ...
            'egiid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
