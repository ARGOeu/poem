...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['subject']
        db.delete_unique(u'poem_userprofile', ['subject'])

        # Adding unique constraint on 'UserProfile', fields ['egiid']
        db.create_unique(u'poem_userprofile', ['egiid'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['egiid']
        db.delete_unique(u'poem_userprofile', ['egiid'])

        # Adding unique constraint on 'UserProfile', fields ['subject']
        db.create_unique(u'poem_userprofile', ['subject'])
