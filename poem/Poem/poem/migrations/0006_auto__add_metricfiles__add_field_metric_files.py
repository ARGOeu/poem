...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetricFiles'
        db.create_table(u'poem_metricfiles', (
        ...
        db.send_create_signal('poem', ['MetricFiles'])

        # Adding field 'Metric.files'
        db.add_column(u'poem_metric', 'files',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MetricFiles'
        db.delete_table(u'poem_metricfiles')

        # Deleting field 'Metric.files'
        db.delete_column(u'poem_metric', 'files')
