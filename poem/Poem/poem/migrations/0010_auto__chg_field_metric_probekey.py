...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Metric.probekey'
        db.alter_column(u'poem_metric', 'probekey_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reversion.Version'], null=True))

    def backwards(self, orm):

        # Changing field 'Metric.probekey'
        db.alter_column(u'poem_metric', 'probekey_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['reversion.Version']))
    ...
    models = {
        ...
        'poem.metric': {
            ...
            'probekey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reversion.Version']", 'null': 'True', 'blank': 'True'}),
